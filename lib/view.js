...
var View = function () {
    ...
    _createClass(View, [{
        ...
        value: function render(data) {
            ...
            // Will not work with jquery > 1.7
            // https://api.jquery.com/selector/
            elementSelector = this.elementSelector ? this.elementSelector : this.$element.selector,
                $selector = $data.find(elementSelector);
            if (!$selector.length) {
                $selector = $data.filter(elementSelector);
            }
